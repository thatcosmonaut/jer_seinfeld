...
async function main()
{
    ...
    filteredToots = toots.filter((toot) => !toot.reblog && !toot.sensitive && (toot.in_reply_to_id == null || toot.in_reply_to_id == jerID) && (toot.in_reply_to_account_id == null || toot.in_reply_to_account_id == jerID));
